...
public class Activity_sexo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Activity_sexo.this, Activity_areas_cuerpo.class);

                if (image1.getScaleX() > image2.getScaleX()) {
